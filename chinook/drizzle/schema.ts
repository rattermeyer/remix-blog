...
export const albumInChinook = chinook.table(
	"album",
	{
	...
	(table) => {
		return {
			artist_id_idx: index("album_artist_id_idx").using(
				"btree",
				table.artist_id,
			),
		};
...
export const employeeInChinook = chinook.table(
	"employee",
	{
	...
	(table) => {
		return {
			reports_to_idx: index("employee_reports_to_idx").using(
				"btree",
				table.reports_to,
			),
...
export const customerInChinook = chinook.table(
	"customer",
	{
		...
		support_rep_id: integer("support_rep_id").references(
			() => employeeInChinook.employee_id,
		),
	},
	(table) => {
		return {
			support_rep_id_idx: index("customer_support_rep_id_idx").using(
				"btree",
				table.support_rep_id,
			),
		};
	},
);

export const invoice_lineInChinook = chinook.table(
	"invoice_line",
	{
	...
	(table) => {
		return {
			invoice_id_idx: index("invoice_line_invoice_id_idx").using(
				"btree",
				table.invoice_id,
			),
			track_id_idx: index("invoice_line_track_id_idx").using(
				"btree",
				table.track_id,
			),
		};
...
export const trackInChinook = chinook.table(
	"track",
	{
	...
	(table) => {
		return {
			...
			media_type_id_idx: index("track_media_type_id_idx").using(
				"btree",
				table.media_type_id,
			),
		};
...
export const invoiceInChinook = chinook.table(
	"invoice",
	{
	...
	(table) => {
		return {
			customer_id_idx: index("invoice_customer_id_idx").using(
				"btree",
				table.customer_id,
			),
		};
...
export const playlist_trackInChinook = chinook.table(
	"playlist_track",
	{
	...
	(table) => {
		return {
			playlist_id_idx: index("playlist_track_playlist_id_idx").using(
				"btree",
				table.playlist_id,
			),
			track_id_idx: index("playlist_track_track_id_idx").using(
				"btree",
				table.track_id,
			),
			playlist_track_pkey: primaryKey({
